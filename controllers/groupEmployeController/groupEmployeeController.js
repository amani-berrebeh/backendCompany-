...
async function createGroupAndAssignEmployees(req, res) {
  ...
  try {
      const newGroup = await groupEmployeeService.createGroupAndAssignEmployees(groupData, employeeIds);
...
const addNewGroup = async (req, res) => {
 ...
 module.exports ={getGroups, createGroupAndAssignEmployees,addNewGroup, getAllGroups, getGroupEmployeeById, updateGroupEmployee, deleteGroupEmployee, getGroupByIdCompany}